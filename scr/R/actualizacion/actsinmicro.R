...
dirdataccaa <- "./datos/datos_ori/CCAA"
dirdatataric <- "./datos/datos_ori/TARIC"
dirdatapaises <- "./datos/datos_ori/Paises"
pathsalida <- "./datos/ccaacappais/datos_brutos_de_alt.xlsx"
salida_path <- "./datos/ccaacappais"
...
mapregiones <-  data.table::as.data.table(readxl::read_excel("./actualizacion/mapeos/regiones.xlsx"))
mappaises <-  data.table::as.data.table(readxl::read_excel("./actualizacion/mapeos/estados.xlsx"))
maptarics <-  data.table::as.data.table(readxl::read_excel("./actualizacion/mapeos/capitulos.xlsx"))
