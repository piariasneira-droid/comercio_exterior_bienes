...
# Destildar para ejecución en local. Desde .qmd cargamos estos paramet
# setwd("/home/pivan/Documentos/comercio_exterior_bienes/scr/R/actualizacion")
...
# Lectura de datos
base_path <- "../../../data/output/ccaacappais"
