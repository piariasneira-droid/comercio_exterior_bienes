...
grafica_contribuciones_paises <- function(datafr, aux, vals) {
  ...
  # Extraer valores de las listas
  nom_flujo <- aux$nombre_flujo
  nivel_taric <- aux$nivel_taric_producto
  var <- aux$var
  varud <- aux$varud
